...
def func(*args):  # Упаковывает заранее неизвестное количество аргументов в кортеж
    print(sum(args) * 0.06)
...
def func(**kwargs):  # Упаковывает заранее неизвестное количество именованных элементов в словарь
    print(kwargs)
